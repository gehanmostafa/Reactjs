        ...
        <div className="container w-[80%] m-auto">
          ...
          <div className=" text-[24px] font-semibold leading-10  ">
            ...
            <p >
              ...
              requirements for villas, apartments, and private offices.
            </p>
            <p>
              CI Group is much more than a typical supplying or designing
              company. Our experts elevate the experience of creation and
              implementation to higher levels that leave a perfect impression on
              all visitors to your place.
            </p>
            <p>
              The planning and design must reflect attention to the details that
